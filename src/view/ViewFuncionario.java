...
public class ViewFuncionario extends javax.swing.JFrame {
    ...
    ArrayList<ModelFuncionario> listModelFuncionarios = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        btPesquisarFuncionario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/18x18/Search.png"))); // NOI18N
        ...
        if (tbFuncionarios.getColumnModel().getColumnCount() > 0) {
            tbFuncionarios.getColumnModel().getColumn(1).setPreferredWidth(250);
        }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(tfPesquisaFuncionario, javax.swing.GroupLayout.PREFERRED_SIZE, 431, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btCancelar, btPesquisarFuncionario});
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {btAlterar, btCancelar, btNovo, btPesquisarFuncionario});
   ...
   private boolean alteraFuncionario() {
        modelFuncionario.setCodigo(Integer.parseInt(this.tfCodigo.getText()));
        modelFuncionario.setNome(this.tfNome.getText());
        modelFuncionario.setEndereco(this.tfEndereco.getText());
        modelFuncionario.setBairro(this.tfBairro.getText());
        modelFuncionario.setCidade(this.tfCidade.getText());
        modelFuncionario.setUf(this.tfUf.getText());
        modelFuncionario.setCep(this.tfCep.getText());
        modelFuncionario.setTelefone(this.tfTelefone.getText());
    ...
    private boolean recuperarFuncionario() {
        ...
        int codigo = (Integer) tbFuncionarios.getValueAt(linha, 0);
        ...
        try {
            ...
            this.tfCidade.setText(modelFuncionario.getCidade());
            this.tfUf.setText(modelFuncionario.getUf());
            this.tfCep.setText(modelFuncionario.getCep());
            this.tfTelefone.setText(modelFuncionario.getTelefone());
            return true;
        } catch (Exception e) {
     ...
     private void carregarFuncionarios() {
        listModelFuncionarios = controllerFuncionario.getListaFuncionarioController();
        DefaultTableModel modelo = (DefaultTableModel) tbFuncionarios.getModel();
        modelo.setNumRows(0);
        //CARREGA OS DADOS DA LISTA NA TABELA
        int cont = listModelFuncionarios.size();
        for (int i = 0; i < cont; i++) {
            modelo.addRow(new Object[]{
                listModelFuncionarios.get(i).getCodigo(),
                listModelFuncionarios.get(i).getNome(),
                listModelFuncionarios.get(i).getCidade(),
                listModelFuncionarios.get(i).getUf()
            });
        }
    }
